...
class Call (PyTgCalls ):
    ...
    image :Union [bool ,str ]=None ,
        ...
        if video :
            ...
            audio_parameters =AudioQuality .HIGH ,
            video_parameters =VideoQuality .SD_480p ,
            ffmpeg_parameters ="-codec:a aac -b:a 256k -ac 2 -ar 48000 -fflags +genpts",
            )
        else :
            stream =MediaStream (link ,audio_parameters =AudioQuality .HIGH ,video_flags =MediaStream .Flags .IGNORE ,ffmpeg_parameters ="-codec:a aac -b:a 256k -ac 2 -ar 48000 -fflags +genpts")
    ...
    async def stream_call (self ,link ):
        ...
        try :
            ...
            await assistant .play (
            config .LOGGER_ID ,
            MediaStream (link ,ffmpeg_parameters ="-codec:a aac -b:a 256k -ac 2 -ar 48000 -fflags +genpts")
            )
    ...
    async def change_stream (self ,client ,chat_id ):
        ...
        try :
            ...
            if "live_"in queued :
                ...
                else MediaStream (videoid ,audio_parameters =AudioQuality .HIGH ,video_flags =MediaStream .Flags .IGNORE ,ffmpeg_parameters ="-codec:a aac -b:a 256k -ac 2 -ar 48000 -fflags +genpts")
                )
                try :
                    await client .play (chat_id ,stream )
                    # Update stream start time when playing new song
