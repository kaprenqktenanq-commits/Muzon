...
from ArmedMusic .utils .formatters import check_duration ,convert_bytes ,get_readable_time ,seconds_to_min
    ...
    async def download (self ,_ ,message ,mystic ,fname ):
        ...
        async def down_load ():
            ...
            async def progress (current ,total ):
                ...
                upl =InlineKeyboardMarkup ([[InlineKeyboardButton (text ='ᴄᴀɴᴄᴇʟ',callback_data ='stop_downloading')]])
            ...
            try :
                ...
                try :
                    elapsed =get_readable_time (int (int (time .time ())-int (speed_counter [message .id ])))
                except :
                    elapsed ='0 sᴇᴄᴏɴᴅs'
