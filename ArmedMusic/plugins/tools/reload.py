...
from ArmedMusic .utils .database import get_assistant ,get_authuser_names ,get_cmode
from ArmedMusic .utils .decorators import ActualAdminCB ,AdminActual ,language
from ArmedMusic .utils .formatters import alpha_to_int ,get_readable_time
...
async def stop_download (client ,CallbackQuery :CallbackQuery ,_ ):
    ...
    if not task .done ():
        try :
            ...
            return await CallbackQuery .edit_message_text (_ ['tg_7'].format (CallbackQuery .from_user .mention ))
        except :
