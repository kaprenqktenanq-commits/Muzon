...
class Call (PyTgCalls ):
    ...
    image :Union [bool ,str ]=None ,
        ...
        if video :
            ...
            audio_parameters =AudioQuality .HIGH ,
            video_parameters =VideoQuality .SD_480p ,
            ffmpeg_parameters ="-reconnect 1 -reconnect_streamed 1 -reconnect_delay_max 5 -ar 48000 -ac 2 -b:a 256k",
            )
        else :
            stream =MediaStream (link ,audio_parameters =AudioQuality .HIGH ,video_flags =MediaStream .Flags .IGNORE ,ffmpeg_parameters ="-reconnect 1 -reconnect_streamed 1 -reconnect_delay_max 5 -ar 48000 -ac 2 -b:a 256k")
    ...
    async def stream_call (self ,link ):
        ...
        try :
            ...
            await assistant .play (
            config .LOGGER_ID ,
            MediaStream (link ,ffmpeg_parameters ="-reconnect 1 -reconnect_streamed 1 -reconnect_delay_max 5 -ar 48000 -ac 2 -b:a 256k")
            )
