                ...
                if await is_active_chat (chat_id ):
                    if basic [videoid ]:
                        if await is_music_playing (chat_id ):
                            try :
                                buttons =queue_markup (_ ,DUR ,'c'if cplay else 'g',videoid ,seconds_to_min (db [chat_id ][0 ]['played']),db [chat_id ][0 ]['dur'])
...
async def queue_back (client ,CallbackQuery :CallbackQuery ,_ ):
    ...
    upl =queue_markup (_ ,DUR ,cplay ,videoid )if DUR =='Unknown'else queue_markup (_ ,DUR ,cplay ,videoid ,seconds_to_min (got [0 ]['played']),got [0 ]['dur'])
    basic [videoid ]=True
            ...
            while db [chat_id ][0 ]['vidid']==videoid :
                ...
                if await is_active_chat (chat_id ):
                    if basic [videoid ]:
                        if await is_music_playing (chat_id ):
                            try :
                                buttons =queue_markup (_ ,DUR ,cplay ,videoid ,seconds_to_min (db [chat_id ][0 ]['played']),db [chat_id ][0 ]['dur'])
                                await mystic .edit_reply_markup (reply_markup =buttons )
                            except FloodWait :
                                pass
                        else :
